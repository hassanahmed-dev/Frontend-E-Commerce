      ...
      try {
        ...
        const productImages =
          productData?.images && productData.images.length > 0
            ? productData.images
            : [productData?.imageUrl || productData?.image || "/placeholder.png"];
    ...
    try {
      ...
      const cartAction = await dispatch(
        addToCart({
          ...
          quantity,
          color: selectedColor || (product.colors && product.colors[0]?.color) || "",
        })
      );
    ...
    <>
      ...
      <div className="product-container">
        <div className="breadcrumb">
          ...
          <span> / </span>
          <Link href="/products" className="breadcrumb-link">Product</Link>
          <span> / </span>
          ...
          <div className="product-info">
            ...
            {product?.colors && product?.colors.length > 0 && (
              <div className="color-selection">
                ...
                {addCartError && <div style={{ color: "red", marginTop: 8 }}>{addCartError}</div>}
              </div>
            )}
            ...
            <div className="cart-actions">
              ...
              {addCartSuccess && <div style={{ color: "green", marginTop: 8 }}>{addCartSuccess}</div>}
              <button
            ...
            <div className="info-card shipping">
              <div className="info-content">
                ...
                <div className="info-text">
                  ...
                  <p className="info-description">Enter your postal code for Delivery Availability</p>
                </div>
            ...
            {activeTab === "reviews" && (
              <div className="reviews-content">
                ...
                >
                  ...
                  <button className="post-review-btn" onClick={handlePostReviewClick}>
                    Post Review
                  </button>
                </div>
                      ...
                      <div key={idx} className="review-card">
                        <div className="review-stars">
                          {[...Array(5)].map((_, index) => (
                            <svg
                              key={index}
                              className={`review-star ${index < review.rating ? "filled" : "empty"}`}
                              fill="currentColor"
                              viewBox="0 0 20 20"
                            >
                              <path d="M9.049 2.927c.3-.921 1.603-.921 1.902 0l1.07 3.292a1 1 0 00.95.69h3.462c.969 0 1.371 1.24.588 1.81l-2.8 2.034a1 1 0 00-.364 1.118l1.07 3.292c.3.921-.755 1.688-1.54 1.118l-2.8-2.034a1 1 0 00-1.175 0l-2.8 2.034c-.784.57-1.838-.197-1.539-1.118l1.07-3.292a1 1 0 00-.364-1.118L2.98 8.72c-.783-.57-.38-1.81.588-1.81h3.461a1 1 0 00.951-.69l1.07-3.292z" />
                ...
                {showReviewModal && (
                  ...
                  >
                    ...
                    >
                      <h2 style={{ marginBottom: "", fontFamily: "Poppins" }}>Enter Your Review</h2>
                      ...
                      <div style={{ display: "flex", justifyContent: "flex-end", gap: "1rem" }}>
                        <button className="postcancelbtn" onClick={() => setShowReviewModal(false)}>Cancel</button>
                        <button
                          className="postaddbtn"
                          onClick={handlePostReview}
                          disabled={postingReview || !reviewScore || !reviewText}
                        >
