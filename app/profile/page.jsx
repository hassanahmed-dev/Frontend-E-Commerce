...
//   const handleSave = () => {
//     console.log("EditNameModal Save clicked:", firstName, lastName);
...
//   if (!isOpen) return null
//   const handleSave = () => {
//     console.log("EditPhoneModal Save clicked:", phone);
//     onSave(phone)
//   }
//   return (
//     <div className="modal-overlay2" onClick={onClose}>
//       <div className="modal2" onClick={(e) => e.stopPropagation()}>
//         <h3 className="modal-title2">Edit Phone no</h3>
//         <div className="form-group2">
//           <label className="label2">Phone no</label>
//             <input
//               type="tel"
...
//       console.log("User ID or token missing", user);
//       return;
//     }
//     const name = `${firstName} ${lastName}`.trim();
//     try {
//       console.log("Dispatching updateProfile...", { id: user.userId, name, phone: user.phone, token: user.token });
//       await dispatch(updateProfile({ id: user.userId, name, phone: user.phone, token: user.token })).unwrap();
//       console.log("updateProfile dispatched");
//       const freshUser = await dispatch(getProfile({ id: user.userId, token: user.token })).unwrap();
//       console.log("getProfile dispatched", freshUser);
...
//                 <h2 className="welcome-title2">Hellow, {user?.name}</h2>
//               </div>
